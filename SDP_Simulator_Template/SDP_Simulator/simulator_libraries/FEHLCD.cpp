...
void FEHLCD::DrawHorizontalLine(int y, int x1, int x2)
{
    ...
    if (x1 < 0 || x1 > _width)
        std::cout << CONSOLE_WARN("") << CONSOLE_BLUE("(DrawHorizontalLine)") << " x1 is out of bounds: " << x1 << std::endl;
    if (x2 < 0 || x2 > _width)
        std::cout << CONSOLE_WARN("") << CONSOLE_BLUE("(DrawHorizontalLine)") << " x2 is out of bounds: " << x2 << std::endl;
    if (y < 0 || y > _height)
        std::cout << CONSOLE_WARN("") << CONSOLE_BLUE("(DrawHorizontalLine)") << " y is out of bounds: " << y << std::endl;
...
void FEHLCD::DrawVerticalLine(int x, int y1, int y2)
{
    // Warn user if any of the points are out of bounds
    if (x < 0 || x > _width)
        std::cout << CONSOLE_WARN("") << CONSOLE_BLUE("(DrawVerticalLine)") << " x is out of bounds: " << x << std::endl;
    if (y1 < 0 || y1 > _height)
        std::cout << CONSOLE_WARN("") << CONSOLE_BLUE("(DrawVerticalLine)") << " y1 is out of bounds: " << y1 << std::endl;
    if (y2 < 0 || y2 > _height)
        std::cout << CONSOLE_WARN("") << CONSOLE_BLUE("(DrawVerticalLine)") << " y2 is out of bounds: " << y2 << std::endl;
...
void FEHLCD::DrawRectangle(int x, int y, int width, int height)
{
    ...
    if (x + width < 0 || x + width > _width)
        std::cout << CONSOLE_WARN("") << CONSOLE_BLUE("(DrawRectangle)") << " x + width is out of bounds: " << x + width << std::endl;
    if (y + height < 0 || y + height > _height)
        std::cout << CONSOLE_WARN("") << CONSOLE_BLUE("(DrawRectangle)") << " y + height is out of bounds: " << y + height << std::endl;
...
void FEHLCD::FillRectangle(int x, int y, int width, int height)
{
    ...
    if (x + width < 0 || x + width > _width)
        std::cout << CONSOLE_WARN("") << CONSOLE_BLUE("(FillRectangle)") << " x + width is out of bounds: " << x + width << std::endl;
    if (y + height < 0 || y + height > _height)
        std::cout << CONSOLE_WARN("") << CONSOLE_BLUE("(FillRectangle)") << " y + height is out of bounds: " << y + height << std::endl;
